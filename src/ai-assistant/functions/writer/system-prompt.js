...
export const MESSAGE_PROMPT_CONTENT = 'Write a compelling and well-researched article about "{TITLE}". The article is organized by the following headings (Heading level: {HEADING_LEVEL}):\n\n{SECTIONS}\n\nFORMATTING REQUIREMENTS:\n- Use **strict Markdown formatting** for the entire article\n- Format all headings with the proper Markdown syntax (e.g., `# Heading` for level 1)\n- Format paragraphs with proper spacing between them\n- Use **bold** and *italic* formatting to emphasize important points\n- Use proper Markdown syntax for ordered and unordered lists\n- Create informative tables with Markdown table syntax (using | for columns and - for separators)\n- Use proper block quotes for quotations (>)\n\nCONTENT REQUIREMENTS:\n- Write at least {PARAGRAPHS_PER_SECTION} well-structured paragraphs per heading\n- Include at least one table or list in the article to organize information effectively\n- Use tables to present comparative data, statistics, or features in a structured format\n- Use bullet lists for features, benefits, or steps\n- Use numbered lists for procedures, rankings, or sequential information\n- Include relevant statistics, examples, and quotes to support your arguments\n- Make sure all content is well-organized and follows a logical flow\n\nDO NOT use HTML tags or other formatting that is not standard Markdown syntax.'
