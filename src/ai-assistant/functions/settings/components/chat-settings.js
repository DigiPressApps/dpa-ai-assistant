		...
		>
			<VStack spacing={ 3 }>
				...
				<SelectControl
					...
					__nextHasNoMarginBottom
					label={ <>
						{__( 'Content Structure', dpaa.i18n ) }
						<PopoverHelp
							buttonText=''
							buttonClass='__right-inline-position'
							buttonSize='small'
				...
				<RangeControl
					...
					__next40pxDefaultSize
					label={ <>
						{ `${ __( 'Max number of chat logs', dpaa.i18n ) } (${ __( 'For AI', dpaa.i18n ) })` }
						<PopoverHelp
							buttonText=''
							buttonClass='__right-inline-position'
							buttonSize='small'
				...
				<RangeControl
					...
					__next40pxDefaultSize
					label={ <>
						{`${ __( 'Max number of chat logs', dpaa.i18n ) } (${ __( 'For display', dpaa.i18n ) })` }
						<PopoverHelp
							buttonText=''
							buttonClass='__right-inline-position'
							buttonSize='small'
